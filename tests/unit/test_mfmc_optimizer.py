...
def ui_optimizer():
    ...
    return Optimizer(model_costs, covariance)


def test_optimizer_returns_tuple_with(ui_optimizer):
...
def test_non_matching_covariance_and_costs_lengths():
    ...
    with pytest.raises(ValueError):
        ...
        _ = optimizer.optimize(algorithm="mfmc", target_cost=30)
...
def test_optimize_with_small_target_cost(ui_optimizer, target_cost):
    opt_result = ui_optimizer.optimize(algorithm="mfmc",
